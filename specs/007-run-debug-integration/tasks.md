...
- [x] T004 [P] Extend Run and Debug workspace fixtures in `test-fixtures/workspaces/debug-launch-valid/tf-tools-manifest.yaml`
- [x] T005 Create shared debug-profile fixture helpers in `src/test/unit/workflow-test-helpers.ts`
...
- [x] T010 [US1] Register the Run and Debug provider lifecycle in `src/extension.ts`
- [x] T011 [US1] Contribute proxy debug activation and compatibility metadata in `package.json`
