...
- **FR-009**: The system MUST build a substitution map from the active model, target, component, selected debug entry name, resolved artifact folder, derived executable values, and any additional variables declared by the selected debug entry.
