...
- [X] T017 [US1] Preserve exact artifact-resolution semantics for `artifactFolder`, `artifactName`, and `artifactSuffix` in `src/intellisense/artifact-resolution.ts` and `src/intellisense/intellisense-types.ts`
