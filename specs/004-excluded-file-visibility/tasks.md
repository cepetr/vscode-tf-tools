...
- [ ] T008 [P] [US1] Add unit tests for basename-only matching, case-sensitive evaluation, `/`-separator normalization, absolute and workspace-relative folder globs, and empty-scope disabling in `src/test/unit/workflow/excluded-files-service.test.ts`
