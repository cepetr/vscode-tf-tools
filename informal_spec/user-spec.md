...
- The `Upload` command shall use a dynamic title in the form `Trezor: Upload {model-name} | {target-display} | {component-name}` and shall invoke `xtask upload <component-id>`.
