...
### 6. Debug Launch
Component-scoped debug-entry resolution, declaration-order matching, template loading, derived executable artifact handling, `Executable` row behavior, header and overflow `Start Debugging` actions, substitution variables, debug API launch, and debug-specific errors and logging.
